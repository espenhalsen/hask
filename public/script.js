...
const changeRoom = () => {
        ...
        var newroom=prompt('Enter new Room-ID');
        if(newroom) location.assign(newroom);
    }
const disconnect = () => {
      var disconnect=confirm("Are you sure you want to disconnect?");
      if(disconnect) window.location.href = "https://halsendata.com";
  }
const shareRoom = () => {
